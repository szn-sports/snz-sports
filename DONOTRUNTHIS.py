...
playerSkills = {
    'Physical' : {'Strength' : 0, 'Speed' : 0, 'Endurance' : 0}, 
...
for pid in range(0,1696):
    ...
    while skillsAssigned == False:
        playerInfo['Skills']['Physical']['Strength'] = random.randint(0,49)
        playerInfo['Skills']['Physical']['Speed'] = random.randint(0,49)
        playerInfo['Skills']['Physical']['Endurance'] = random.randint(0,49)
        playerInfo['Skills']['Blocking']['Run Blocking'] = random.randint(0,49)
        playerInfo['Skills']['Blocking']['Pass Blocking'] = random.randint(0,49)
        playerInfo['Skills']['Passing']['Passing Vision'] = random.randint(0,49)
        playerInfo['Skills']['Passing']['Passing Power'] = random.randint(0,49)
        playerInfo['Skills']['Passing']['Passing Accuracy'] = random.randint(0,49)
        playerInfo['Skills']['Defense']['Pass Coverage'] = random.randint(0,49)
        playerInfo['Skills']['Defense']['Tackling'] = random.randint(0,49)
        playerInfo['Skills']['Defense']['Pass Rushing'] = random.randint(0,49)
        playerInfo['Skills']['Defense']['Run Stopping'] = random.randint(0,49)
        playerInfo['Skills']['Rushing/Receiving']['Elusiveness'] = random.randint(0,49)
        playerInfo['Skills']['Rushing/Receiving']['Route Running'] = random.randint(0,49)
        playerInfo['Skills']['Rushing/Receiving']['Hands'] = random.randint(0,49)
        playerInfo['Skills']['Rushing/Receiving']['Ball Security'] = random.randint(0,49)
        playerInfo['Skills']['Kicking']['Kick Power'] = random.randint(0,49)
        playerInfo['Skills']['Kicking']['Kick Accuracy'] = random.randint(0,49)
        playerInfo['Skills']['Kicking']['Punt Power'] = random.randint(0,49)
        playerInfo['Skills']['Kicking']['Punt Accuracy'] = random.randint(0,49)
        if position =='Quarterback':
            if notCommonSkill() == 10:
                playerInfo['Skills']['Physical']['Speed'] = random.randint(50,80)
            playerInfo['Skills']['Passing']['Passing Vision'] = random.randint(50,80)
            playerInfo['Skills']['Passing']['Passing Power'] = random.randint(50,80)
            playerInfo['Skills']['Passing']['Passing Accuracy'] = random.randint(50,80)    
            playerInfo['Skills']['Rushing/Receiving']['Elusiveness'] = random.randint(50,80)
            playerInfo['Skills']['Rushing/Receiving']['Ball Security'] = random.randint(50,80)
        elif position == 'Offensive Linemen':
            playerInfo['Skills']['Physical']['Strength'] = random.randint(50,80)
            playerInfo['Skills']['Blocking']['Run Blocking'] = random.randint(50,80)
            playerInfo['Skills']['Blocking']['Pass Blocking'] = random.randint(50,80)
        elif position == 'Wide Receiver': 
            playerInfo['Skills']['Physical']['Speed'] = random.randint(50,80)
            playerInfo['Skills']['Physical']['Endurance'] = random.randint(50,80)
            playerInfo['Skills']['Rushing/Receiving']['Elusiveness'] = random.randint(50,80)
            playerInfo['Skills']['Rushing/Receiving']['Route Running'] = random.randint(50,80)
            playerInfo['Skills']['Rushing/Receiving']['Hands'] = random.randint(50,80)
            playerInfo['Skills']['Rushing/Receiving']['Ball Security'] = random.randint(50,80)
            ...
            playerInfo['Skills']['Blocking']['Run Blocking'] = random.randint(50,80)
            playerInfo['Skills']['Blocking']['Pass Blocking'] = random.randint(50,80)
            playerInfo['Skills']['Defense']['Pass Coverage'] = random.randint(50,80)
            playerInfo['Skills']['Defense']['Tackling'] = random.randint(50,80)
            playerInfo['Skills']['Defense']['Pass Rushing'] = random.randint(50,80)
            playerInfo['Skills']['Defense']['Run Stopping'] = random.randint(50,80)
            ...
            playerInfo['Skills']['Kicking']['Kick Power'] = random.randint(50,80)
            playerInfo['Skills']['Kicking']['Kick Accuracy'] = random.randint(50,80)
            playerInfo['Skills']['Kicking']['Punt Power'] = random.randint(50,80)
            playerInfo['Skills']['Kicking']['Punt Accuracy'] = random.randint(50,80)
        ...
        playerInfo['Apperence']['Overall Rating'] = overallRating
    ...
    artistList[pid] = {
        ...
        'Player Skills' : {
            'Physical - Strength' : playerInfo['Skills']['Physical']['Strength'],
            'Physical - Speed' : playerInfo['Skills']['Physical']['Speed'],
            'Physical - Endurance' : playerInfo['Skills']['Physical']['Endurance'],
            'Blocking - Run Blocking' : playerInfo['Skills']['Blocking']['Run Blocking'],
            'Blocking - Pass Blocking' : playerInfo['Skills']['Blocking']['Pass Blocking'],
            'Passing - Passing Vision' : playerInfo['Skills']['Passing']['Passing Vision'],
            'Passing - Passing Power' : playerInfo['Skills']['Passing']['Passing Power'],
            'Passing - Passing Accuracy' : playerInfo['Skills']['Passing']['Passing Accuracy'],
            'Defense - Pass Coverage' : playerInfo['Skills']['Defense']['Pass Coverage'],
            'Defense - Tackling' : playerInfo['Skills']['Defense']['Tackling'],
            'Defense - Pass Rushing' : playerInfo['Skills']['Defense']['Pass Rushing'],
            'Defense - Run Rushing' : playerInfo['Skills']['Defense']['Run Stopping'],
            'Rushing/Receiving - Elusiveness' : playerInfo['Skills']['Rushing/Receiving']['Elusiveness'],
            'Rushing/Receiving - Route Running' : playerInfo['Skills']['Rushing/Receiving']['Route Running'],
            'Rushing/Receiving - Hands' : playerInfo['Skills']['Rushing/Receiving']['Hands'],
            'Rushing/Receiving - Ball Security' : playerInfo['Skills']['Rushing/Receiving']['Ball Security'],
            'Kicking - Kick Power' : playerInfo['Skills']['Kicking']['Kick Power'],
            'Kicking - Kick Accuracy' : playerInfo['Skills']['Kicking']['Kick Accuracy'],
            'Kicking - Punt Power' : playerInfo['Skills']['Kicking']['Punt Power'],
            'Kicking - Punt Accuracy' : playerInfo['Skills']['Kicking']['Punt Accuracy']

        },
        'Overall Rating ' : playerInfo['Apperence']['Overall Rating'],
...
test.sort()
print(test[0], ' ', test[-1], (sum(test)/len(test)))
